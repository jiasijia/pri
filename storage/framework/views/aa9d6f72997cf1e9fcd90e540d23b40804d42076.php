...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" width="64" height="64" src="<?php echo e(URL::asset('/')); ?>img/swal1.jpg" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
                                <span class="clear">
                                <span class="block m-t-xs"><strong class="font-bold">不吃肉的少年</strong></span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo e(URL::route('authAuthGetLogout')); ?>">安全退出</a>
                                </li>
                            </ul>
                        </div>
                        <div class="logo-element">悦</div>
                    </li>
                    <li>
                        <a href="javascript:;">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="" data-index="0">管理员管理</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="" data-index="0">相册管理</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                <button class="roll-nav roll-left J_tabLeft"><i class="fa fa-backward"></i>
                	<a href="javascript:;" class="active J_menuTab" data-id="<?php echo e(URL::route('adminIndex')); ?>"></a>
                </button>
                ...
                <a href="<?php echo e(URL::route('authAuthGetLogout')); ?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo e(URL::route('adminIndex')); ?>" frameborder="0" data-id="" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2015-2016
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
        ...
        <div id="right-sidebar">
            <div class="sidebar-container">
                ...
                <ul class="nav nav-tabs navs-3">
                    ...
                    <li class="active">
                        <a data-toggle="tab" href="javascript:;tab-1">
    ...
    <script src="<?php echo e(URL::asset('/')); ?>js/hplus.min862f.js?v=4.1.0"></script>
    <script src="<?php echo e(URL::asset('/')); ?>js/contabs.min.js"></script>
