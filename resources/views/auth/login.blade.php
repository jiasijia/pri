...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('/') }}login/css/normalize.css" />
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('/') }}login/css/default.css">
	<link rel='stylesheet prefetch' href='http://fonts.useso.com/css?family=Open+Sans'>
	<link rel="stylesheet" type="text/css" href="{{ URL::asset('/') }}login/css/styles.css">
...
<script src='{{ URL::asset('/') }}login/js/stopExecutionOnTimeout.js?t=1'></script>
...
$(function(){
    ...
    $(document).on('click', '.login__submit', function (e) {
        ...
        $.ajax({
			url: "{{ URL::route('authAuthPostLogin') }}", 
